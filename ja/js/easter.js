...
var data = [
    ...
    {
        id: 7,
        keyword: "独自に開発したフォーマットを利用することでユーザーをロックする",
        clicked: false
    },
    ...
    {
        id: 9,
        keyword: "彼ら自身のデータの完全な所有権とコントロール",
        clicked: false
    },
...
var title = "イースターおめでとう、ドキュメントの自由を手に入れましょう！";
var text = "このゲームを楽しんでいただけて、ドキュメントの自由、Open Document FormatおよびLibreOfficeの重要さを完璧に理解しいただけたたらうれしいです。私たちのデジタルドキュメントの解放を始めましょう！！";
...
function init(){
    // update count
    $("#box")[0].innerText = `${sum} / ${data.length} 発見`;
}
